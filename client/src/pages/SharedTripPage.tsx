      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '20px 16px' }}>
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: 28,
                          borderRadius: '50%',
                          background: selectedDay === day.id ? '#111827' : '#f3f4f6',
                            ...
                            return (
                              ...
                              >
                                ...
                                <div>
                                  ...
                                  {item.data.time && (
                                    <div style={{ fontSize: 10, color: '#9ca3af' }}>{item.data.time}</div>
                                  )}
                                </div>
                              </div>
                            );
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      borderRadius: 20,
                      fontWeight: 600,
                      background: r.status === 'confirmed' ? 'rgba(22,163,74,0.1)' : 'rgba(217,119,6,0.1)',
        ...
        <div style={{ textAlign: 'center', padding: '40px 0 20px' }}>
          ...
          >
            ...
            <span style={{ fontSize: 11, color: '#9ca3af' }}>
              {t('shared.sharedVia')} <strong style={{ color: '#6b7280' }}>TREK</strong>
            </span>
          </div>
          <div style={{ marginTop: 8, fontSize: 10, color: '#d1d5db' }}>
            Made with <span style={{ color: '#ef4444' }}>&hearts;</span> by Maurice ·{' '}
            <a href="https://github.com/mauriceboe/TREK" style={{ color: '#9ca3af', textDecoration: 'none' }}>
              GitHub
            </a>
          </div>
        </div>
