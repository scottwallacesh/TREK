...
import { addonsApi, authApi, journeyApi, mapsApi } from '../api/client';
...
import type { GalleryPhoto, JourneyDetail, JourneyEntry, JourneyPhoto, JourneyTrip } from '../store/journeyStore';
...
function ProviderPicker({
  ...
  return (
    <div
      className="fixed inset-0 z-[9999] flex items-end justify-center overscroll-none md:items-center md:p-5"
...
function ContributorInviteDialog({
  journeyId,
  existingUserIds,
  onClose,
  onInvited,
...
function JourneySettingsDialog({
  journey,
  onClose,
  onSaved,
  onOpenInvite,
  ...
  return (
    <div
      className="fixed inset-0 z-[200] flex items-end justify-center overscroll-none md:items-center md:p-5"
      style={{ background: 'rgba(9,9,11,0.75)' }}
      onClick={handleClose}
      onTouchMove={(e) => {
        if (e.target === e.currentTarget) e.preventDefault();
