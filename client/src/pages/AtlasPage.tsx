...
import { Briefcase, ChevronRight, Globe, MapPin, Plus, Search, Star, X } from 'lucide-react';
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <p className="text-3xl font-black tabular-nums leading-none" style={{ color: 'var(--text-primary)' }}>
            ...
            {[
              ...
              <div key={i} className="px-1 text-center">
                <p className="text-xl font-black tabular-nums leading-none" style={{ color: 'var(--text-primary)' }}>
                  {v}
                </p>
                <p
                  className="mt-1 text-[9px] font-semibold uppercase tracking-wide"
