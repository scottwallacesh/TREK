        ...
        <div className="mx-auto max-w-[1440px]">
          ...
          <div className="hidden px-8 pb-7 pt-10 md:block">
            ...
            >
              ...
              <span style={{ fontSize: 13, color: 'var(--text-muted)' }}>{t('journey.frontpage.subtitle')}</span>
                      ...
                      <div className="mt-0.5 text-[13px]">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: t('journey.frontpage.suggestionText', { title: activeSuggestion.title }),
                          }}
                        />
                      </div>
                    </div>
                ...
                >
                  ...
                  {activeJourney.cover_image && (
                    <div className="absolute inset-0 z-[1]">
                      <img
                        src={`/uploads/${activeJourney.cover_image}`}
