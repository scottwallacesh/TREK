        ...
        <div className="grid grid-cols-4 gap-1">
          {years.map((y) => (
            <div
              ...
              className="group relative cursor-pointer rounded-lg py-1.5 text-center text-xs font-medium transition-[background-color,color] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)]"
              style={{
        ...
        <div className="mx-auto max-w-[1800px] px-3 py-4 sm:px-4 sm:py-6">
          ...
          <div className="mb-4 flex items-center justify-between lg:hidden">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm transition-colors lg:hidden"
          ...
          <div className="hidden lg:block" style={{ marginBottom: 20 }}>
            ...
            >
              ...
              <span style={{ fontSize: 13, color: 'var(--text-muted)' }}>{t('vacay.subtitle')}</span>
      ...
      {showMobileSidebar &&
        ReactDOM.createPortal(
          <div className="fixed inset-0 lg:hidden" style={{ zIndex: 99980 }}>
            ...
            />
            <div
              className="absolute bottom-0 left-0 top-0 flex w-[280px] flex-col gap-3 overflow-y-auto p-3"
              style={{
        ...
        ReactDOM.createPortal(
          ...
          >
            {incomingInvites.map((inv) => (
              <div
                key={inv.id}
                className="trek-modal-enter w-full max-w-md overflow-hidden rounded-2xl shadow-2xl"
...
function InfoItem({
  ...
  return (
    <div className="flex items-start gap-3 rounded-lg px-3 py-2" style={{ background: 'var(--bg-secondary)' }}>
