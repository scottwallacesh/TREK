...
export default function FileManager({
  ...
  const renderFileRow = (file: TripFile, isTrash = false) => {
    ...
    const linkedReservations = [...allLinkedResIds]
      .map((rid) => reservations?.find((r) => r.id === rid))
      .filter(Boolean);
    return (
      <div
        key={file.id}
            ...
            >
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
                  <button
                    onClick={() =>
                      openFileUrl(previewFile.url, previewFile.original_name).catch(() =>
      ...
      <div style={{ padding: '24px 28px 0', flexShrink: 0 }} className="max-md:!px-4 max-md:!pt-4">
        ...
        >
            ...
            <>
              ...
              <div className="hidden md:inline-flex" style={{ gap: 4, flexWrap: 'wrap', flex: 1, minWidth: 0 }}>
                {[
                  ...
                  ...(files.some((f) => f.note_id)
                    ? [{ id: 'collab', label: t('files.filterCollab') || 'Collab' }]
                    : []),
                ].map((tab) => {
          ...
          >
            ...
            <span className="hidden sm:inline">{t('files.trash') || 'Trash'}</span>
          </button>
        </div>
      </div>
