...
import type { Assignment, AssignmentsMap, Category, Day, Place, Reservation, RouteResult, Trip } from '../../types';
import {
  TRANSPORT_TYPES,
  ...
  const handleOptimize = async () => {
    ...
    const optimizedAssignments =
      unlockedWithCoords.length >= 2
        ? optimizeRoute(unlockedWithCoords.map((a) => ({ ...a.place, _assignmentId: a.id })))
          ...
          return (
            <div key={day.id} style={{ borderBottom: '1px solid var(--border-faint)' }}>
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          const border =
                            isCheckOut && !isCheckIn
                              ...
                              : isCheckIn
                                ...
                                : 'var(--border-primary)';
                          const iconColor =
                            isCheckOut && !isCheckIn ? '#ef4444' : isCheckIn ? '#22c55e' : 'var(--text-muted)';
                          return (
                            <span
                              key={acc.id}
                              onClick={(e) => {
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 2, flexWrap: 'wrap' }}>
                    ...
                    {day.date && anyGeoPlace && (
                      <span
                        style={{ width: 1, height: 10, background: 'var(--text-faint)', opacity: 0.3, flexShrink: 0 }}
                      />
                    )}
                    {day.date &&
                      anyGeoPlace &&
                ...
                {canEditDays && (
                  <Tooltip label={t('dayplan.addNote')} placement="top">
                    <button
                  ...
                  {merged.length === 0 && !dayNoteUi ? (
                    ...
                    merged.map((item, idx) => {
                      ...
                      const showDropLineAfter =
                        ...
                        dropTargetKey === `transport-after-${item.data.id}-${day.id}`;
                                ...
                                {(() => {
                                  ...
                                  return (
                                    <div style={{ marginTop: 3, display: 'inline-flex', alignItems: 'center', gap: 4 }}>
                                      ...
                                      {canEditDays &&
                                        (() => {
                                          const isTransport = ['flight', 'train', 'car', 'cruise', 'bus'].includes(
                                            res.type
                                          );
                                ...
                                >
                                  <button
                                    ...
                                    style={{
                                      ...
                                      color: idx === 0 ? 'var(--border-primary)' : 'var(--text-faint)',
                                      display: 'flex',
                                      lineHeight: 1,
                                    }}
                                  >
                                  ...
                                  <button
                                    ...
                                    style={{
                                      ...
                                      color: idx === merged.length - 1 ? 'var(--border-primary)' : 'var(--text-faint)',
                                      display: 'flex',
                                      lineHeight: 1,
                                    }}
                                  >
                                ...
                                ? (e) =>
                                    ctxMenu.open(e, [
                                      ...
                                      { divider: true },
                                      {
                                        ...
                                        icon: Trash2,
                                        danger: true,
                                        onClick: () => deleteNote(day.id, note.id),
                                      },
                                    ])
                                : undefined
                            }
                          ...
                          >
                            ...
                            {canEditDays && (
                              ...
                              >
                                ...
                                <button
                                  onClick={(e) => deleteNote(day.id, note.id, e)}
                                  style={{
                                    background: 'none',
                                    border: 'none',
                                    padding: 2,
                              ...
                              >
                                <button
                                  ...
                                  style={{
                                    ...
                                    color: noteIdx === 0 ? 'var(--border-primary)' : 'var(--text-faint)',
                                    display: 'flex',
                                    lineHeight: 1,
                                  }}
                                >
                                ...
                                <button
                                  ...
                                  style={{
                                    ...
                                    color:
                                      noteIdx === merged.length - 1 ? 'var(--border-primary)' : 'var(--text-faint)',
                                    display: 'flex',
                                    lineHeight: 1,
                                  }}
                                >
              ...
              >
                  ...
                  {NOTE_ICONS.map(({ id, Icon }) => (
                    <button
                      ...
                      style={{
                        ...
                        background: ui.icon === id ? 'var(--bg-hover)' : 'transparent',
                        cursor: 'pointer',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                ...
                <div
                  style={{
                    textAlign: 'right',
                    fontSize: 11,
                    color: (ui.time?.length || 0) >= 140 ? '#d97706' : 'var(--text-faint)',
                    marginTop: -2,
                  }}
                >
                  {ui.time?.length || 0}/150
                </div>
                <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
                  ...
                  <button
                    ...
                    style={{
                      fontSize: 12,
                      background: !ui.text?.trim() ? 'var(--border-primary)' : 'var(--accent)',
                      color: !ui.text?.trim() ? 'var(--text-faint)' : 'var(--accent-text)',
                      border: 'none',
                      borderRadius: 8,
                      padding: '6px 16px',
            ...
            >
              {(() => {
                ...
                if (res.type === 'flight') {
                  ...
                  if (meta.platform)
                    detailFields.push({ label: t('reservations.meta.platform'), value: meta.platform });
                  if (meta.seat) detailFields.push({ label: t('reservations.meta.seat'), value: meta.seat });
                }
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                        {detailFields.map((f, i) => {
                          ...
                          return (
                            <div
                              key={i}
                              style={{ padding: '8px 10px', background: 'var(--bg-tertiary)', borderRadius: 8 }}
                            >
                              <div
                                style={{
                                  fontSize: 9,
