    ...
    >
      ...
      >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            {place.lat && place.lng && (
              <div
                ...
                style={{ fontSize: 11, color: 'var(--text-faint)', marginTop: 4, fontVariantNumeric: 'tabular-nums' }}
              >
        ...
        <div style={{ overflowY: 'auto', padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          {(() => {
            const res = selectedAssignmentId
              ? reservations.find((r) => r.assignment_id === selectedAssignmentId)
              : null;
                      ...
                      >
                        <div
                          style={{
                            ...
                            gap: 8,
                            padding: '6px 10px',
                            background: confirmed ? 'rgba(22,163,74,0.08)' : 'rgba(217,119,6,0.08)',
                          }}
                        >
                          <div
                            style={{
                          ...
                          />
                          <span style={{ fontSize: 10, fontWeight: 700, color: confirmed ? '#16a34a' : '#d97706' }}>
                        ...
                        <div style={{ padding: '6px 10px', display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                          ...
                          {res.confirmation_number && (
                            <div>
                              ...
                              <div
                                style={{ fontSize: 10, fontWeight: 500, color: 'var(--text-primary)', marginTop: 1 }}
                              >
                                {res.confirmation_number}
                              </div>
                            </div>
                  ...
                  <div style={{ padding: '0 12px 10px' }}>
                    {openingHours.map((line, i) => (
                      <div
                        ...
                        style={{
                          fontSize: 12,
                          color: i === weekdayIndex ? 'var(--text-primary)' : 'var(--text-muted)',
                    ...
                    >
                      ...
                      {pathD && (
                        <svg
                          ...
                          style={{ display: 'block', borderRadius: 6, background: 'var(--bg-tertiary)' }}
                        >
                          <defs>
