    ...
    (e: React.MouseEvent, place: Place) => {
      ...
      ctxMenu.open(e, [
        ...
        selDayId && {
          ...
          icon: CalendarDays,
          onClick: () => onAssignToDay(place.id, selDayId),
        },
        place.website && {
        ...
        place.lat &&
          place.lng && {
            ...
            onClick: () =>
              window.open(
                `https://www.google.com/maps/search/?api=1&query=${(place as any).google_place_id ? encodeURIComponent(place.name) + '&query_place_id=' + (place as any).google_place_id : place.lat + ',' + place.lng}`,
                '_blank'
              ),
          },
        { divider: true },
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (selectedIds.size > 0)
                  e.currentTarget.style.background = 'color-mix(in srgb, #ef4444 14%, transparent)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = 'transparent';
              }}
            ...
            >
              <div style={{ padding: '16px 20px 12px', borderBottom: '1px solid var(--border-secondary)' }}>
                ...
                {dayPickerPlace.address && (
                  <div style={{ fontSize: 12, color: 'var(--text-faint)', marginTop: 2 }}>{dayPickerPlace.address}</div>
                )}
              </div>
