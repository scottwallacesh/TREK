    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              ...
              {collapsed && formattedDate && (
                <span style={{ fontWeight: 500, color: 'var(--text-muted)', marginLeft: 8 }}>{formattedDate}</span>
              )}
            </div>
            {!collapsed && formattedDate && (
              <div style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 1 }}>{formattedDate}</div>
            )}
          </div>
          <button
            onClick={(e) => {
          ...
          >
            {collapsed ? (
              <ChevronsUp size={14} style={{ color: 'var(--text-muted)' }} />
            ) : (
              <ChevronsDown size={14} style={{ color: 'var(--text-muted)' }} />
            )}
          </button>
          <button
            onClick={(e) => {
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {dayAccommodations.map((acc) => {
                  ...
                  return (
                    <div
                      key={acc.id}
                      style={{ borderRadius: 12, background: 'var(--bg-secondary)', overflow: 'hidden' }}
                    >
                      {/* Day label */}
                      {dayLabel && (
                      ...
                      >
                        {acc.check_in && (
                          ...
                          >
                            <div
                              style={{ fontSize: 12, fontWeight: 700, color: 'var(--text-primary)', lineHeight: 1.2 }}
                            >
                      ...
                      {linked && (
                        ...
                        >
                          ...
                          <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <div
                              style={{ fontSize: 9, color: 'var(--text-faint)', display: 'flex', gap: 6, marginTop: 1 }}
                            >
                            ...
                            onChange={(v) =>
                              setHotelDayRange((prev) => ({
                                start: v,
                                  ...
                                  days.findIndex((d) => d.id === v) > days.findIndex((d) => d.id === prev.end)
                                    ? v
                                    : prev.end,
                              }))
                            }
