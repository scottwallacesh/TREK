      ...
      <Section title={t('settings.account')} icon={User}>
        ...
        <div style={{ paddingTop: 16, marginTop: 16, borderTop: '1px solid var(--border-secondary)' }}>
          <div className="mb-3 flex items-center gap-2">
            ...
            <h3 className="m-0 text-base font-semibold" style={{ color: 'var(--text-primary)' }}>
          ...
          <div className="space-y-3">
            ...
            <p className="m-0 text-sm" style={{ color: 'var(--text-muted)', lineHeight: 1.5 }}>
            ...
            {demoMode ? (
              ...
              <>
                <p className="m-0 text-sm font-medium" style={{ color: 'var(--text-secondary)' }}>
                ...
                {!user?.mfa_enabled && mfaQr && (
                  <div className="space-y-3">
                    ...
                    <div
                      className="mx-auto block overflow-hidden rounded-lg border"
                      style={{ width: 'fit-content', borderColor: 'var(--border-primary)' }}
                    ...
                    <div>
                      ...
                      <code
                        className="block break-all rounded p-2 text-xs"
                ...
                {backupCodes && backupCodes.length > 0 && (
                  <div
                    ...
                    style={{ borderColor: 'var(--border-primary)', background: 'var(--bg-hover)' }}
                  >
                    ...
                    <pre
                      className="m-0 overflow-auto rounded border p-2 text-xs"
                      style={{
                        borderColor: 'var(--border-primary)',
                        background: 'var(--bg-card)',
                        color: 'var(--text-primary)',
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 }}>
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium text-red-500 transition-colors hover:bg-red-50"
