  ...
  return (
    <>
      ...
      {mcpEnabled && (
        <Section title={t('settings.mcp.title')} icon={Terminal}>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="rounded-lg border p-2 transition-colors hover:bg-slate-100 dark:hover:bg-slate-700"
            ...
            <>
              ...
              <div className="overflow-hidden rounded-lg border" style={{ borderColor: 'var(--border-primary)' }}>
                <button
                  ...
                  className="flex w-full items-center justify-between px-3 py-2.5 transition-colors hover:bg-slate-50 dark:hover:bg-slate-800"
                  ...
                  <div className="border-t p-3" style={{ borderColor: 'var(--border-primary)' }}>
                    <div className="mb-1.5 flex justify-end">
                      <button
                        ...
                        className="flex items-center gap-1.5 rounded border px-2.5 py-1 text-xs transition-colors hover:bg-slate-100 dark:hover:bg-slate-700"
                    ...
                    <pre
                      className="overflow-x-auto rounded-lg border p-3 font-mono text-xs"
                      style={{
                        background: 'var(--bg-secondary)',
                        borderColor: 'var(--border-primary)',
                        color: 'var(--text-primary)',
                  ...
                  <div className="overflow-hidden rounded-lg border" style={{ borderColor: 'var(--border-primary)' }}>
                    {oauthClients.map((client, i) => (
                      <div
                        ...
                        className="px-4 py-3"
                        style={{
                          borderBottom: i < oauthClients.length - 1 ? '1px solid var(--border-primary)' : undefined,
                        }}
                      >
                            ...
                            <div className="mt-1.5 flex flex-wrap gap-1">
                              ...
                              {client.allowed_scopes.length > 5 && (
                                <button
                                  ...
                                  className="rounded px-1.5 py-0.5 text-xs transition-colors hover:bg-slate-100 dark:hover:bg-slate-700"
                  ...
                  <div className="overflow-hidden rounded-lg border" style={{ borderColor: 'var(--border-primary)' }}>
                    {oauthSessions.map((session, i) => (
                      <div
                        ...
                        style={{
                          borderBottom: i < oauthSessions.length - 1 ? '1px solid var(--border-primary)' : undefined,
                        }}
                      >
                        <div className="min-w-0 flex-1">
                          <p className="truncate text-sm font-medium" style={{ color: 'var(--text-primary)' }}>
                        ...
                        <button
                          ...
                          className="rounded border px-2.5 py-1 text-xs transition-colors hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20"
          ...
          {activeMcpTab === 'apitokens' && (
            <>
              <div
                className="flex items-baseline gap-2 rounded-lg px-3 py-2.5"
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm font-medium opacity-60 transition-colors"
      ...
      {mcpModalOpen && (
        ...
        >
          <div className="w-full max-w-md space-y-4 rounded-xl p-6 shadow-xl" style={{ background: 'var(--bg-card)' }}>
            {!mcpCreatedToken ? (
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-slate-400"
                    style={{
                      borderColor: 'var(--border-primary)',
                      background: 'var(--bg-secondary)',
                      color: 'var(--text-primary)',
              ...
              <>
                ...
                <div
                  className="flex items-start gap-2 rounded-lg border border-amber-200 p-3"
                ...
                <div className="relative">
                  <pre
                    className="whitespace-pre-wrap break-all rounded-lg border p-3 pr-10 font-mono text-xs"
                    style={{
                      background: 'var(--bg-secondary)',
                      borderColor: 'var(--border-primary)',
                      color: 'var(--text-primary)',
                  ...
                  <button
                    ...
                    className="absolute right-2 top-2 rounded p-1.5 transition-colors hover:bg-slate-200 dark:hover:bg-slate-600"
      ...
      {oauthCreateOpen && (
        ...
        >
          <div
            className="max-h-[90vh] w-full max-w-lg space-y-4 overflow-y-auto rounded-xl p-6 shadow-xl"
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {OAUTH_PRESETS.map((preset) => (
                      <button
                        ...
                        className="rounded-md border px-2.5 py-1 text-xs font-medium transition-colors hover:bg-slate-100 dark:hover:bg-slate-700"
                        style={{
                          borderColor: 'var(--border-primary)',
                ...
                {!oauthIsMachine && (
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full resize-none rounded-lg border px-3 py-2.5 font-mono text-sm focus:outline-none focus:ring-2 focus:ring-slate-400"
                      style={{
                        borderColor: 'var(--border-primary)',
                        background: 'var(--bg-secondary)',
                        color: 'var(--text-primary)',
