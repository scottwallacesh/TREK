...
export default function VacaySettings({ onClose }: VacaySettingsProps) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Dissolve fusion */}
      {isFused && (
        <div className="mt-2 border-t pt-4" style={{ borderColor: 'var(--border-secondary)' }}>
          <div className="overflow-hidden rounded-xl" style={{ border: '1px solid rgba(239,68,68,0.2)' }}>
            <div className="flex items-center gap-3 px-4 py-3" style={{ background: 'rgba(239,68,68,0.06)' }}>
              <div
...
function CalendarRow({
  ...
  return (
    <div className="flex items-start gap-3 rounded-xl p-3" style={{ background: 'var(--bg-secondary)' }}>
