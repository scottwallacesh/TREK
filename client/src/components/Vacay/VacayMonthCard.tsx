...
export default function VacayMonthCard({
  ...
  return (
    ...
    >
      <div className="border-b px-3 py-2" style={{ borderColor: 'var(--border-secondary)' }}>
        <span className="text-xs font-semibold" style={{ color: 'var(--text-primary)', textTransform: 'capitalize' }}>
          {monthName}
        </span>
      </div>
        ...
        {weekdays.map((wd, i) => {
          ...
          return (
            <div
              ...
              style={{ color: isWeekendCol ? 'var(--text-faint)' : 'var(--text-muted)' }}
            >
              {wd}
            </div>
          );
            ...
            {week.map((day, di) => {
              ...
              return (
                ...
                >
                  ...
                  {isCompany && (
                    <div className="absolute inset-0.5 rounded" style={{ background: 'rgba(245,158,11,0.15)' }} />
                  )}
                  ...
                  {tripDates?.has(dateStr) && (
                    <span
                      className="absolute right-[3px] top-[3px] z-[2] h-[5px] w-[5px] rounded-full"
