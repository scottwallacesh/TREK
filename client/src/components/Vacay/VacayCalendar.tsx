...
export default function VacayCalendar() {
  ...
  return (
    <div>
      <div className="grid grid-cols-1 gap-3 pb-14 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      ...
      {/* Floating toolbar */}
      <div className="sticky bottom-3 z-30 mt-3 flex items-center justify-center px-2 sm:bottom-4 sm:mt-4">
        <div
          className="flex items-center gap-1.5 rounded-xl border px-2 py-1.5 sm:gap-2 sm:px-3 sm:py-2"
          style={{
        ...
        >
          <button
            ...
            className="flex items-center gap-1 rounded-lg px-2 py-1.5 text-[11px] font-medium transition-[background-color,color,border-color] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] sm:gap-1.5 sm:px-3 sm:text-xs"
            style={{
