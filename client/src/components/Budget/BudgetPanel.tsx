  ...
  return (
    <tr style={{ background: 'var(--bg-secondary)' }}>
      ...
      <td
        ...
        style={{ padding: '4px 6px', color: 'var(--text-faint)', fontSize: 12, textAlign: 'center' }}
      >
        -
      </td>
      <td
                        ...
                        return (
                          ...
                          >
                                  ...
                                  {hasMultipleMembers && (
                                    <div className="sm:hidden" style={{ marginTop: 4 }}>
                                      <BudgetMemberChips
                                        ...
                                        onTogglePaid={(userId, paid) =>
                                          toggleBudgetMemberPaid(tripId, item.id, userId, paid)
                                        }
                                        compact={false}
                                        readOnly={!canEdit}
                                      />
                            ...
                            <td
                              ...
                              style={{ ...td, textAlign: 'center', position: 'relative' }}
                            >
                              {hasMultipleMembers ? (
                                <BudgetMemberChips
                                  members={item.members || []}
                                ...
                                <InlineEditCell
                                  ...
                                  decimals={0}
                                  onSave={(v) =>
                                    handleUpdateField(item.id, 'persons', v != null ? parseInt(v) || null : null)
                                  }
                                  style={{ textAlign: 'center' }}
                                  placeholder="-"
                                  locale={locale}
                            ...
                            <td className="hidden sm:table-cell" style={{ ...td, textAlign: 'center' }}>
                              <InlineEditCell
                                ...
                                decimals={0}
                                onSave={(v) =>
                                  handleUpdateField(item.id, 'days', v != null ? parseInt(v) || null : null)
                                }
                                style={{ textAlign: 'center' }}
                                placeholder="-"
                                locale={locale}
        ...
        >
          ...
          >
            ...
            {(() => {
              ...
              return (
                <div
                  style={{ display: 'flex', alignItems: 'baseline', gap: 4, letterSpacing: '-0.03em', lineHeight: 1 }}
                >
            ...
            (() => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    style={{ position: 'relative', display: 'flex', justifyContent: 'center', margin: '4px 0 16px' }}
                  >
                    <svg
                      width={200}
                      height={200}
                    ...
                    >
                      ...
                      <div style={{ fontSize: 10.5, color: theme.faint, fontWeight: 500, marginTop: 2 }}>
                        {currency}
                      </div>
                    </div>
                  </div>
